...
-define(UB32, 32/unsigned-big-integer).
-define(UB24, 24/unsigned-big-integer).
-define(UB16, 16/unsigned-big-integer).
-define(UB8,  8/unsigned-big-integer).
-define(UB4,  4/unsigned-big-integer).
-define(UB(N), N/unsigned-big-integer).

-define(SB32, 32/signed-big-integer).
-define(SB24, 24/signed-big-integer).
-define(SB16, 16/signed-big-integer).
-define(SB8,  8/signed-big-integer).
-define(SB(N), N/signed-big-integer).

-define(DB64, 64/signed-big-float).

-define(UL32, 32/unsigned-little-integer).
-define(UL24, 24/unsigned-little-integer).
-define(UL16, 16/unsigned-little-integer).
-define(UL8,  8/unsigned-little-integer).
...
%%%-------------------------------------------------------------------
-record(rtmp,{id,stream,type,stamp,len,next,body}).
-record(rtmp_func,{id,func,info,parms}).
